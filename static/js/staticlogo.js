...
var ddsitelogo={
	...
	logoHTML: '<img onclick="spawnSlime()" src="/static/images/SlimeStackFinal.gif" style="width:50px; height:47px; border:0" />', //HTML for logo, which is auto wrapped in DIV w/ ID="mysitelogo"
